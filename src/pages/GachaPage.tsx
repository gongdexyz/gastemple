...
const BUDDHA_ROASTS = {
  cn: [
    "你不怕归零。你怕卖早了然后发现自己错了。姐姐懂你，但市场不懂。💫",
    "这个币可能会涨。但当它涨的时候，你还会拿着吗？（酷飒）",
    "你不是来分析的。你是来寻求许可的。别骗自己了，来，姐姐给你个拥抱。🤗",
    "姐姐看图表没问题。姐姐看你的纪律有问题。（搞笑）",
    "如果信念足够，你就不会一直刷新价格。说好的长期持有呢？😅",
    "这不是个坏币。它只是被没耐心的人持有。比如你~（卖萌）",
    "你说'长期持有'。姐姐听到的是'直到它变红'。别装了亲~ 💕",
    "市场不是在测试这个币。它是在测试你。加油，姐姐看好你！（暖心）",
    "你能活过这次交易。我不确定你能活过你的情绪。深呼吸，慢慢来~",
    "姐姐不担心项目。姐姐担心你的手。能不能别抖了？😂"
  ],
  en: [
...
const BUDDHA_VERDICTS = {
  ...
  // 低风险 (ponziLevel <= 40) - 佛性祝福
  low: {
    cn: [
      "放下执念，立地成佛。此币尚可，施主好自为之。",
...
// 👩 姐姐逃跑建议文案库 - 立体人设（暖心+酷飒+搞笑+卖萌）
const EXIT_ADVICES = {
  // 高风险 (ponziLevel > 70) - 酷飒+搞笑
  high: {
    cn: [
      "快跑！鞋都不要了！赶紧去送两单外卖对冲一下亏损！姐姐认真的。🏃",
      "建议立刻清仓，然后删除所有交易App，假装这一切没发生过。（酷飒）",
      "逃跑路线：先卖币→再卸载App→最后换个手机号重新做人。姐姐陪你~",
      "现在跑还来得及。等庄家砸盘的时候，你连哭的机会都没有。别犹豫了！",
      "姐姐给你指条明路：止损→提现→去庙里上柱香谢罪。然后来找姐姐喝咖啡。☕",
      "跑！往没有WiFi的地方跑！只要看不到行情，就不算亏！（搞笑）",
      "建议操作：全部卖出，然后对着镜子说三遍「我再也不冲土狗了」。姐姐监督你~",
      "逃生指南：1.卖掉 2.删App 3.告诉自己这是学费 4.下次还敢（姐姐懂你😂）",
    ],
    en: [
  ...
  // 中风险 (ponziLevel > 40) - 暖心+搞笑
  medium: {
    cn: [
      "赶紧截图发朋友圈！5分钟后可能就只剩回忆了。姐姐帮你见证~📸",
      "建议设好止盈止损，然后去敲木鱼冷静一下。姐姐陪你。",
      "现在是逃跑的好时机。当然，你也可以等跌了再后悔。（搞笑）",
      "姐姐建议：先卖一半落袋为安，剩下的...随缘吧。至少保住本金~",
      "趁现在还有利润，赶紧跑。等你想跑的时候，可能已经是负的了。别犹豫！",
      "逃跑窗口期：现在。错过这个村，就没这个店了。姐姐提醒你哦~",
      "建议操作：获利了结，然后假装自己是投资大师发个朋友圈。姐姐不会拆穿你😏",
      "姐姐掐指一算，你还有3分钟的逃跑时间。抓紧！💨",
    ],
    en: [
